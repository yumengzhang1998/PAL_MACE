...
class MLP(ks.layers.Layer):
    ...
    def __init__(self,
        ...
        self.dense_activ = ks.activations.deserialize(config=dense_activ, custom_objects={'leaky_softplus': leaky_softplus,
                                                                                   'shifted_softplus': shifted_softplus,
                                                                                   'sharp_softplus': sharp_softplus
                                                                                   })
        self.dense_activ_last_serialize = dense_activ_last
        self.dense_activ_last = ks.activations.deserialize(config=dense_activ_last,
        ...
        if self.dropout_use:
            self.mlp_dropout = ks.layers.Dropout(rate=self.dropout_dropout, name=self.name + '_dropout')
