#! /bin/bash
#SBATCH --job-name=bi11-3_samples
...
cd ..
python boot_strap_with_fixed_samples.py --atom bi --num_atom 11 --charge="-3_samples" --num_samples 5 --config mace.yaml --results_dir results/mace 
