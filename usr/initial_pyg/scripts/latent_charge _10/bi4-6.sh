...
cd ..
python boot_strap_with_fixed_samples.py --atom bi --num_atom 4 --charge -6 --num_samples 5 --config latentcharge.yaml --results_dir results/latent_charge_10 --penalty 10  --latent True