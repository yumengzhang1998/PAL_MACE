...
cd ..
python boot_strap_with_fixed_samples.py --atom bi --num_atom 4 --charge -6 --num_samples 5 --config charge_head.yaml --results_dir results/charge_head --penalty 1 --latent True