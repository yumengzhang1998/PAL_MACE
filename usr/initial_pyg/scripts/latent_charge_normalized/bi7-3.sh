...
cd ..
python boot_strap_with_fixed_samples.py --atom bi --num_atom 7 --charge -3 --num_samples 5 --config latentcharge_normalized.yaml --results_dir results/latentcharge_normalized