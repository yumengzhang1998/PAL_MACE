#! /bin/bash
#SBATCH --job-name=synthesis_L_normalized
...
cd ..
python boot_strap_with_fixed_samples.py --atom bi --num_atom 11 --charge="-3_samples" --num_samples 5 --config latentcharge_normalized.yaml --results_dir results/latentcharge_normalized
