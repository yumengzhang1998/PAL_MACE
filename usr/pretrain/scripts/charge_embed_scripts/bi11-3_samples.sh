...
cd ../..
python boot_strap_with_fixed_samples.py --atom bi --num_atom 11 --charge="-3_samples" --num_samples 5 --config charge_embedding.yaml --results_dir results/charge_embedding_low_rmax
