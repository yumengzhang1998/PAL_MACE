...
cd ..
python boot_strap_with_fixed_samples.py --atom bi --num_atom 11 --charge="-3_samples" --num_samples 5 --config latentcharge_embed.yaml --results_dir results/latent_charge_embed_10 --penalty 10 --latent True
