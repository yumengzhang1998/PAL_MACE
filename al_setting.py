...
AL_SETTING = {
    "result_dir": './results/bi11-3',    # directory to save all metadata and results
    "orcl_buffer_path": './results/bi11-3/orcl_buffer',    # path to save data ready to send to ML. Set to None to skip buffer backup.
    "ml_buffer_path": './results/bi11-3/ml_buffer',    # path to save data ready to send to Oracle. Set to None to skip buffer backup.
