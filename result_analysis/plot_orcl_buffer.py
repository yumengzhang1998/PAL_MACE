...
def plot_kept_trend(df, save_name="orcl_buffer_consumption.png"):
    plt.figure(figsize=(10,6))

    # Plot kept and total
    plt.plot(df["iteration"], df["kept"], 
             label="Kept after filtering", marker="o", linewidth=2)
...
path = "../results/bi11-3_samples_org/syn_3872972.out"
